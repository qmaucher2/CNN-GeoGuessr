...
model = keras.Sequential([
    ...
    layers.Conv2D(filters=32, kernel_size=3, activation='relu', padding='same',
                  input_shape=[250, 250, 3], bias_regularizer=regularizers.L1(0.01)),
    tf.keras.layers.BatchNormalization(),
    layers.MaxPool2D(),

    layers.Conv2D(filters=64, kernel_size=3, activation='relu', padding='same', bias_regularizer=regularizers.L1(0.01)),
    layers.MaxPool2D(),
...
# Compile the model
model.compile(
    optimizer=tf.keras.optimizers.Adam(epsilon=0.00001, learning_rate=1e-5),
...
batch_checkpoint = tf.keras.callbacks.ModelCheckpoint(
    filepath="C:/Users/quent/OneDrive/GeoML_QM/best_model04.keras",
    save_weights_only=False,
    save_freq=25
)

checkpoint_filepath = "C:/Users/quent/OneDrive/GeoML_QM/best_model04.keras"
