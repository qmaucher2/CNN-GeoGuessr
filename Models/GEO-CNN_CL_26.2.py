...
model = keras.Sequential([
    ...
    layers.Conv2D(filters=32, kernel_size=3, activation='relu', padding='same', input_shape=[275, 275, 3]),
    layers.MaxPool2D(),
...
batch_checkpoint = tf.keras.callbacks.ModelCheckpoint(
    filepath="C:/Users/quent/OneDrive/GeoML_QM/best_model03.keras",
    save_weights_only=False,
    save_freq=25
)

checkpoint_filepath = "C:/Users/quent/OneDrive/GeoML_QM/best_model03.keras"
